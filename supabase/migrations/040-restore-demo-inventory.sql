-- Migration 040 - Restore the original demo inventory items if missing.
-- Idempotent: existing items are not overwritten.

insert into public.inventory (
  name, type, quantity, unit, cost, supplier, storage_location, reorder_level,
  created_at, updated_at, chemical_type, expiration_date, safety_level,
  hazard_rating, date_received, serial_number, condition,
  last_maintenance_date, next_maintenance_date, manufacturer, model,
  material_category, description
)
select
  v.name, v.type::inventory_type, v.quantity::numeric, v.unit, v.cost::numeric,
  v.supplier, v.storage_location, v.reorder_level::numeric,
  v.created_at::timestamptz, v.updated_at::timestamptz,
  v.chemical_type::chemical_type, v.expiration_date::timestamptz,
  v.safety_level, v.hazard_rating, v.date_received::timestamptz,
  v.serial_number, v.condition::equipment_condition,
  v.last_maintenance_date::timestamptz, v.next_maintenance_date::timestamptz,
  v.manufacturer, v.model, v.material_category::material_category,
  v.description
from (values
  ...
  ('Residual Spray Concentrate', 'CHEMICAL', 8, 'L', 1200, 'BASF Philippines', null, 10, '2026-02-05T08:00:00.000Z', '2026-08-18T00:00:00.000Z', 'INSECTICIDE', '2027-03-20T00:00:00.000Z', 'Medium', 'Use in well-ventilated areas', '2026-02-05T00:00:00.000Z', null, null, null, null, null, null, null, null),
  ('Fogging Solution', 'CHEMICAL', 9, 'L', 2500, 'Bayer CropScience', null, 15, '2026-05-10T08:00:00.000Z', '2026-08-18T00:00:00.000Z', 'FUMIGANT', '2026-12-31T00:00:00.000Z', 'High', 'Hazardous - Requires certification', '2026-05-10T00:00:00.000Z', null, null, null, null, null, null, null, null),
