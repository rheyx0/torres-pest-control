// Moved as-is from pages/inventory/. Only the data wiring changed: inventory
// and addItem come from useInventory() (now Supabase-backed) instead of props
// threaded down through App. The list/form/detail UI below is untouched —
// splitting it into components/inventory/* is deferred, since inventory is
// not a Sprint 1 user story (the backlog mentions it only as "Item Profile").
...
function InventoryPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    // id / createdAt / updatedAt are generated by the database now.
    const newItem = {
      name: form.name.trim(),
      type: form.type,
    ...
    // The write goes to Postgres now, so it can fail — say so rather than
    // clearing the form and looking like it worked.
